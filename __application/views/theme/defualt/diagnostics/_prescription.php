        ...
        <div class="box-body">
            <div class="box-group" id="accordion">
              <div class="panel box box-default">
                ...
                <div class="panel-collapse collapse in">
                  <div class="box-body">
                        <input class="col-sm-12" type="text" id="appment">
                        <button class="col-sm-12" onclick="saveAppoinment();">Save Appoinment</button>
                  </div>
                </div>
              </div>
            </div>
...
<script>
	...
	function addMedicine(){
		...
		$.each(data, function(key,value) {
			...
			htmlView += '<td  style="text-align:center !important;"><input type="text" id="mDoctor" style="padding: 0px !important; text-align: center;" class="form-control" onkeyup="autoDoctor();" value="'+ value.accept_by +'-'+ value.accept_by_phone +'"></td>';
