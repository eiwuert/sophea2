<html>
	...
	<body>
		<div style="float:left"><img style="width:50px !important" src="<?php echo base_url("resources/theme/defualt/img/logoPrint.png")?>"/></div>
			<center style="color:#2F3290 !important;font-size:15px;position: relative;left: -30px;">គ្លីនិកឯកទេសសើស្បែក នឹង ឡេសឺរ រស្មីសោភា<br>Reaksmey Sorphea Skin and Laser Clinic<br><br>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;ប័ណ្ណអនុញ្ញាតពិនិត្យជំងឺ</center>
