<div class="content-wrapper" style="min-height: 916px;">
	...
	<section class="content-header">
		<h1>
			<?php echo '<a href="'.$base_url.'index.php/visitors">'.$h_visitor.'</a>';?>
...
<script>
    ...
    function getVisitorList(mySearch,pageStart,pageLimit){
        ...
        var i = 0;
        var stRow = '';
        $.post("<?php echo $base_url;?>index.php/visitors/get_visitor_list",{
            ...
            $.each(data, function(key,value) {
                htmlView += '<tr ' + stRow + '>';
                    ...
                    htmlView += '<td style="text-align:center;">';
                        htmlView +='<a href="#" title="<?php echo @$leave;?>" onclick="visitorLeave(' + value.visitors_id + ');"><i class="fa fa-external-link  action-btn danger"></i></a>&nbsp;&nbsp;&nbsp;';
    ...
    function pagination(ids){
		...
		getVisitorList(mySearch,pageStart,pageLimit);
	}
